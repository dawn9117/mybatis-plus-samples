 ...
 */
public class ExampleMysqlGenerator {
	...
	public static void main(String[] args) {
		// ======= 定制化参数开始 ======== //
		// 自动生成的表
		String[] tableNames = {"mp_school"};
		// 基础包
		String basePackage = "com.example";
		// mapper.xml存储路径
		String mapperXmlPath = "";
		// 数据库连接
		String dbUrl = "jdbc:mysql://localhost:3306/mp?useUnicode=true&serverTimezone=GMT&useSSL=false&characterEncoding=utf8";
		// 数据库驱动
